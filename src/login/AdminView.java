...
public class AdminView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem13.setText("Monthly Profit/ Loss");
        jMenu2.add(jMenuItem13);

        jMenuItem14.setText("Monthly Revenue/Sales");
        jMenu2.add(jMenuItem14);

        jMenuItem15.setText("Monthly Purchases");
        jMenu2.add(jMenuItem15);

        jMenuItem17.setText("Annual Revenue");
